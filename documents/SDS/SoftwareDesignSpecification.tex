...
Serta\c{c}, Yavuz
 \\\hline
  \centering{5}
 &
\centering{27 April 2015}
 &
Section \ref{sec:description}
 &
\centering{M}
 &
 \raggedright{Diagrams are added}
 &
Berk, Serta\c{c}, Yavuz
 \\\hline
\end{longtable}
\end{flushleft}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.9]{img/architecture.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{img/guiState.png}
\caption{State diagram for user interface}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[scale=0.5]{img/openApp.png}
\caption{Sequence diagram for openning application}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{img/middleware.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{img/submitFilter.png}
\caption{Sequence diagram for course filtering}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{img/configSubmit.png}
\caption{Sequence diagram for submission of configuration}
